-- ------------------------------------------------------------------------------------
--	Baza danych: Bank v.4
--	Dla środowiska: PostgreSQL
--  Autor: Forritarik
--  Data: 2022-04-25
--	
--	Opis: 
--  - skrypt generujący bazę danych Bank v.4
...
/* Na począku stwórz bazę bank poniższych poleceniem
CREATE DATABASE "bank_v.4"
    WITH
    OWNER = postgres
    ENCODING = 'UTF8'
    CONNECTION LIMIT = -1;
...
-- następnie ustaw się w kontekście bazy bank_v.4 i wykonaj poniższy skrypt
...
CREATE TABLE Operacje
    (
		...
		,dataOperacji timestamp without time zone
